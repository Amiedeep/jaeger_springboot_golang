...
{{- define "helm-chart.customerservice.name" -}}
{{- printf "%s-%s" .Chart.Name "customerservice" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- define "helm-chart.customerservice.fullname" -}}
{{- if .Values.fullnameOverride -}}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
...
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s-%s" .Release.Name $name "customerservice" | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
